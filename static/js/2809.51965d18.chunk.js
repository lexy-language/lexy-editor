...
`,we=(0,s.Ay)(y.A)`
  margin-bottom: 24px;
`;function Ee(e){const{variables:n,parent:t}=e;if(!n||0===n.length)return(0,b.jsx)(we,{children:"No parameter variables defined"});const r=[];for(let i=0;i<n.length;i++){const e=n[i];r.push((0,b.jsx)(Pe,{parameter:e,parent:t},i))}return(0,b.jsx)(Te,{children:r})}const Le=(0,s.Ay)(ge.A)`
  width: 100%;
`,ze=(0,s.Ay)(y.A)`
  &:not(:last-child) {
    margin-bottom: 24px;
